...
<div class="grid">
    ...
    <div class="col-12">
            <div class="card">
                <h5>Trainee List Manage</h5>
                <DataTable :value="listStaffTrainee" rowGroupMode="subheader" groupRowsBy="representative.name" sortMode="single" sortField="representative.name" :sortOrder="1" scrollable scrollHeight="550px">
                    <Column field="representative.name" header="Representative"></Column>
                    <Column field="username" header="Name" style="min-width: 200px"></Column>
                    ...
                    <!-- </Column> -->
                    <Column field="Phone" header="Phone Number" style="min-width: 200px"></Column>
                    <Column field="Address" header="Address" style="min-width: 200px">
                        <!-- <template #body="slotProps">
                            <span :class="'customer-badge status-' + slotProps.data.status">{{ slotProps.data.status }}</span>
                        </template> -->
                    </Column>
                    <Column field="BirthDay" header="Date" style="min-width: 200px"></Column>
                    <template #groupheader="slotProps">
                        <img :alt="slotProps.data.representative.name" :src="contextPath + 'demo/images/avatar/' + slotProps.data.representative.image" width="32" style="vertical-align: middle" />
                        <span class="image-text font-bold ml-2">{{ slotProps.data.representative.name }}</span>
                    </template>
...
const listStaffTrainee = ref(null);
...
const calculateCustomerTotal = (name) => {
    ...
    if(listStaffTrainee.value) {
        for(let trainee of listStaffTrainee.value) {
            if(trainee.representative.name === name) {
                total++
            }
        }
    }
