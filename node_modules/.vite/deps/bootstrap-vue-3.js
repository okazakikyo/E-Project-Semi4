...
var Hl = (e, t, a) => t in e ? Dl(e, t, { enumerable: true, configurable: true, writable: true, value: a }) : e[t] = a;
...
var st = (e) => computed(() => e.value ? `justify-content-${e.value}` : "");
var ht = (e, t) => Object.keys(e).filter((a) => !t.includes(a)).reduce((a, l) => ({ ...a, [l]: e[l] }), {});
var Ge = () => ({ enumerable: true, configurable: false, writable: false });
var mt = (e) => Array.isArray(e) ? e.map((t) => mt(t)) : e instanceof Date ? new Date(e.getTime()) : e && typeof e == "object" ? Object.getOwnPropertyNames(e).reduce((t, a) => {
  var l;
...
var Lt = (e) => e !== null && typeof e == "object";
var Oa = (e) => /^[0-9]*\.?[0-9]+$/.test(String(e));
...
var fn2 = /^#[A-Za-z]+[\w\-:.]*$/;
var vn = /-u-.+/;
var bt = (e, t = 2) => typeof e == "string" ? e : e == null ? "" : Array.isArray(e) || rn(e) && e.toString === Object.prototype.toString ? JSON.stringify(e, null, t) : String(e);
var aa = (e) => e.replace(La, " ").replace(za, (t, a, l) => `${a} ${l}`).replace(dn, (t, a, l) => a + l.toUpperCase());
var la = (e) => e.replace(La, " ").replace(za, (t, a, l) => `${a} ${l}`).replace(un, (t, a, l) => a + l.toUpperCase());
var mn = (e) => {
  const t = e.trim();
...
var $t = Da ? document : {};
var Ra = Ha ? navigator : {};
var qa = (Ra.userAgent || "").toLowerCase();
qa.indexOf("jsdom") > 0;
...
var _e = (e, t) => !e || e(t).filter((a) => a.type !== Comment).length < 1;
var Ma = (e, t) => (ze(t) ? t : $t).querySelector(e) || null;
var _n = (e, t) => Array.from([(ze(t) ? t : $t).querySelectorAll(e)]);
var Xt = (e, t) => t && ze(e) ? e.getAttribute(t) : null;
var Vn = (e) => $t.getElementById(/^#/.test(e) ? e.slice(1) : e) || null;
var An = (e, t, a) => {
...
var In = (e, t) => bt(e).toLowerCase() === bt(t).toLowerCase();
var it = Kt ? window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || ((e) => setTimeout(e, 16)) : (e) => setTimeout(e, 0);
var ja = (e, t) => ze(e) ? Bn.call(e, t) : false;
...
var kt = (e, t, a) => t.concat(["sm", "md", "lg", "xl", "xxl"]).reduce((l, n) => (l[e ? `${e}${n.charAt(0).toUpperCase() + n.slice(1)}` : n] = a, l), /* @__PURE__ */ Object.create(null));
var Ga = (e, t, a, l = a) => Object.keys(t).reduce((n, u) => (e[u] && n.push(
...
var It = (e) => !!e && typeof e == "object" && e.constructor === Object;
var zt = (e, t, a = true) => {
...
var sa = (e, t) => t + (e ? mn(e) : "");
var Jt = (e, t) => (Array.isArray(t) ? t.slice() : Object.keys(t)).reduce(
  (a, l) => (a[l] = e[l], a),
  {}
);
var Pn = (e) => typeof e == "boolean" ? e : e === "" ? true : e === "true";
var lt = (e) => !!(e.href || e.to);
function r(e) {
...
var $e = (e, t) => computed(() => (e == null ? void 0 : e.value) || Ee(t));
var tl = {
  ariaInvalid: {
    type: [Boolean, String],
    default: void 0
...
var al = (e, t) => {
  const a = ref();
  let l = null, n = true;
  const u = $e(toRef(e, "id"), "input"), f = (b, k, y = false) => (b = String(b), typeof e.formatter == "function" && (!e.lazyFormatter || y) ? (n = false, e.formatter(b, k)) : b), d = (b) => e.trim ? b.trim() : e.number ? Number.parseFloat(b) : b, v = () => {
    nextTick(() => {
      var b;
...
var Yt = (e, t, a) => Array.isArray(e) ? e.map((l) => Ft(l, null, t, a)) : Object.prototype.toString.call(e) === "[object Object]" ? (console.warn(
...
var Nn = defineComponent({
  ...
  setup(e) {
    const t = e, a = $e(toRef(t, "id"), "accordion"), l = r(toRef(t, "flush")), n = r(toRef(t, "free")), u = computed(() => ({
      "accordion-flush": l.value
    }));
    return n.value || provide(ll, a.value), (f, d) => (openBlock(), createElementBlock("div", {
      id: unref(a),
...
var nl = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "modelValue")), n = r(toRef(a, "toggle")), u = r(toRef(a, "visible")), f = r(toRef(a, "isNav")), d = ref(), v = ref(), p = computed(() => ({
      show: l.value,
    ...
    }), he(d, "shown.bs.collapse", () => t("shown")), he(d, "hidden.bs.collapse", () => t("hidden")), onMounted(() => {
      var m;
    ...
    }), (m, B) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      id: e.id,
      ref_key: "element",
      ref: d,
...
var Rn = (e, t) => {
  ...
  if (In(t.tagName, "a")) {
    const d = Xt(t, "href") || "";
    fn2.test(d) && u.push(d.replace(cn, ""));
  }
...
var ia = (e) => typeof e > "u" ? (console.warn("Review tooltip directive usage. Some uses are not defining a title in root component or a value like `v-b-tooltip='{title: \"my title\"}'` nor `v-b-tooltip=\"'my title'\"` to define a title"), "") : typeof e == "object" ? e == null ? void 0 : e.title : e;
var Gn = {
  beforeMount(e, t) {
...
var eo = defineComponent({
  ...
  setup(e) {
    const t = e, a = inject(ll, ""), l = $e(toRef(t, "id"), "accordion_item"), n = r(toRef(t, "visible"));
...
var ao = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    let f;
    const d = ref(null), v = ref(), p = computed(() => !_e(u.close)), $ = computed(() => !!a.modelValue || n.value), m = computed(() => [
      [`alert-${a.variant}`],
      {
        show: !!a.modelValue,
      ...
      V.value = B(a.modelValue), (T.value || n.value) && !v.value && (v.value = new Alert(d.value));
    }, y = () => {
    ...
    }), V.value = B(a.modelValue), onBeforeUnmount(() => {
      var C;
      b(), (C = v.value) == null || C.dispose(), v.value = void 0;
    }), (C, R) => unref($) ? (openBlock(), createElementBlock("div", {
      key: 0,
      ref_key: "element",
      ref: d,
...
var lo = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "square")), l = computed(() => Nt(t.size)), n = computed(
...
var io = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = useSlots(), n = inject(sl, null), u = ["sm", null, "lg"], f = 0.4, d = f * 0.7, v = r(toRef(a, "badgeLeft")), p = r(toRef(a, "badgeTop")), $ = r(toRef(a, "button")), m = r(toRef(a, "disabled")), B = r(toRef(a, "square")), V = computed(() => !_e(l.default)), T = computed(() => !_e(l.badge)), b = computed(() => !!a.badge || a.badge === "" || T.value), k = computed(
    ...
    })), D = computed(() => [`bg-${a.badgeVariant}`]), F = computed(() => a.badge === true ? "" : a.badge), _ = computed(() => [[`text-${oe(a.badgeVariant)}`]]), N = computed(() => ({
      ...
      btn: $.value,
      [`btn-${y.value}`]: $.value ? !!y.value : false
    })), I = computed(() => [
    ...
    }), Q = computed(() => $.value ? "button" : "span"), Y = computed(() => ({
      ...z.value,
      width: k.value,
      height: k.value
    ...
    return (ee, me) => (openBlock(), createBlock(resolveDynamicComponent(unref(Q)), mergeProps({
      class: ["b-avatar", unref(N)],
      style: unref(Y)
    }, unref(R), { onClick: K }), {
      default: withCtx(() => [
        ...
        unref(b) ? (openBlock(), createElementBlock("span", {
          key: 3,
          class: normalizeClass(["b-avatar-badge", unref(D)]),
          style: normalizeStyle(unref(w))
        }, [
          unref(T) ? renderSlot(ee.$slots, "badge", { key: 0 }) : (openBlock(), createElementBlock("span", {
            key: 1,
...
var ro = defineComponent({
  ...
  setup(e, { emit: t, attrs: a }) {
    const l = r(toRef(e, "active")), n = r(toRef(e, "append")), u = r(toRef(e, "disabled")), f = r(toRef(e, "exact")), d = r(toRef(e, "replace")), v = getCurrentInstance(), p = ref(null), $ = computed(() => {
...
function uo(e, t, a, l, n, u) {
  return e.tag === "router-link" ? (openBlock(), createBlock(resolveDynamicComponent(e.tag), mergeProps({ key: 0 }, e.routerAttr, { custom: "" }), {
    default: withCtx(({ href: f, navigate: d, isActive: v, isExactActive: p }) => [
...
var Ve = Ae(ro, [["render", uo]]);
var ua = ht(We, ["event", "routerTag"]);
var co = defineComponent({
  ...
  setup(e) {
    const t = r(toRef(e, "pill")), a = r(toRef(e, "textIndicator")), l = r(toRef(e, "dotIndicator")), n = r(toRef(e, "active")), u = r(toRef(e, "disabled")), f = computed(() => lt(e)), d = computed(
      () => f.value ? Ve : e.tag
    ), v = computed(() => [
      [`bg-${e.variant}`],
      {
...
var vo = Ae(co, [["render", fo]]);
var da = ht(We, ["event", "routerTag"]);
...
var ho = defineComponent({
  ...
  setup(e) {
    const t = e, a = Ln(), l = computed(() => {
      ...
      let u = false;
      return n.map((d, v) => (typeof d == "string" && (d = { text: d }, v < n.length - 1 && (d.href = "#")), d.active && (u = true), !d.active && !u && (d.active = v + 1 === n.length), d));
    });
    return (n, u) => (openBlock(), createElementBlock("nav", go, [
      createBaseVNode("ol", po, [
        renderSlot(n.$slots, "prepend"),
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(l), (f, d) => (openBlock(), createBlock(il, mergeProps({ key: d }, f), {
          default: withCtx(() => [
...
var Bo = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = r(toRef(e, "active")), l = r(toRef(e, "disabled")), n = r(toRef(e, "pill")), u = r(toRef(e, "pressed")), f = r(toRef(e, "squared")), d = r(toRef(e, "loading")), v = computed(() => u.value === true), p = computed(
      () => e.tag === "button" && e.href === void 0 && e.to === null
    ), $ = computed(() => lt(e)), m = computed(() => e.to !== null), B = computed(
...
var Qt = defineComponent({
  ...
  emits: ["load"],
  setup(e, { emit: t }) {
    const a = e, l = '<svg width="%{w}" height="%{h}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 %{w} %{h}" preserveAspectRatio="none"><rect width="100%" height="100%" style="fill:%{f};"></rect></svg>', n = r(toRef(a, "lazy")), u = r(toRef(a, "blank")), f = r(toRef(a, "block")), d = r(toRef(a, "center")), v = r(toRef(a, "fluid")), p = r(toRef(a, "fluidGrow")), $ = r(toRef(a, "left")), m = r(toRef(a, "start")), B = r(toRef(a, "right")), V = r(toRef(a, "end")), T = r(toRef(a, "thumbnail")), b = computed(
      () => typeof a.srcset == "string" ? a.srcset.split(",").filter((N) => N).join(",") : Array.isArray(a.srcset) ? a.srcset.filter((N) => N).join(",") : void 0
    ), k = computed(
      () => typeof a.sizes == "string" ? a.sizes.split(",").filter((N) => N).join(",") : Array.isArray(a.sizes) ? a.sizes.filter((N) => N).join(",") : void 0
    ), y = computed(() => {
      const N = (P) => P === void 0 ? void 0 : typeof P == "number" ? P : Number.parseInt(P, 10) || void 0, I = N(a.width), w = N(a.height);
      if (u.value) {
    ...
    })), _ = (N, I, w) => `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(
      l.replace("%{w}", String(N)).replace("%{h}", String(I)).replace("%{f}", w)
    )}`;
    return (N, I) => (openBlock(), createElementBlock("img", mergeProps({ class: unref(F) }, unref(R), {
      onLoad: I[0] || (I[0] = (w) => t("load", w))
    }), null, 16));
  }
});
var pt = defineComponent({
  ...
  emits: ["load"],
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "bottom")), n = r(toRef(a, "end")), u = r(toRef(a, "left")), f = r(toRef(a, "right")), d = r(toRef(a, "start")), v = r(toRef(a, "top")), p = computed(
    ...
    return (m, B) => (openBlock(), createBlock(Qt, mergeProps({ class: unref(p) }, unref($), {
...
var fl = defineComponent({
  ...
  setup(e) {
    const t = e, a = useSlots(), l = r(toRef(t, "overlay")), n = computed(() => !_e(a.title)), u = computed(() => !_e(a.subtitle)), f = computed(() => ({
    ...
    return (d, v) => (openBlock(), createBlock(resolveDynamicComponent(e.bodyTag), {
      ...
      default: withCtx(() => [
        !!e.title || unref(n) ? (openBlock(), createBlock(dl, {
          key: 0,
          tag: e.titleTag
        }, {
          default: withCtx(() => [
        ...
        !!e.subtitle || unref(u) ? (openBlock(), createBlock(cl, {
          key: 1,
          tag: e.subtitleTag,
...
var ml = defineComponent({
  ...
  setup(e) {
    const t = e, a = useSlots(), l = r(toRef(t, "imgBottom")), n = r(toRef(t, "imgEnd")), u = r(toRef(t, "imgLeft")), f = r(toRef(t, "imgRight")), d = r(toRef(t, "imgStart")), v = r(toRef(t, "noBody")), p = computed(() => !_e(a.header)), $ = computed(() => !_e(a.footer)), m = computed(() => ({
    ...
    return (k, y) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      ...
      default: withCtx(() => [
        ...
        e.header || unref(p) || e.headerHtml ? (openBlock(), createBlock(ul, mergeProps({ key: 1 }, unref(B), { class: e.headerClass }), {
          default: withCtx(() => [
        ...
        ]) : (openBlock(), createBlock(fl, mergeProps({ key: 2 }, unref(V), { class: e.bodyClass }), {
          default: withCtx(() => [
        ...
        e.footer || unref($) || e.footerHtml ? (openBlock(), createBlock(vl, mergeProps({ key: 4 }, unref(T), { class: e.footerClass }), {
          default: withCtx(() => [
...
var Eo = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = useSlots(), n = $e(toRef(a, "id"), "carousel"), u = r(toRef(a, "controls")), f = r(toRef(a, "indicators")), d = r(toRef(a, "noTouch"));
    r(toRef(a, "noWrap"));
    const v = ref(), p = ref(), $ = ref([]);
    return he(v, "slide.bs.carousel", (m) => t("sliding-start", m)), he(v, "slid.bs.carousel", (m) => t("sliding-end", m)), onMounted(() => {
      ...
      unref(f) ? (openBlock(), createElementBlock("div", Ao, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($.value, (V, T) => (openBlock(), createElementBlock("button", {
          key: T,
          type: "button",
...
var jo = defineComponent({
  ...
  setup(e) {
    const t = e, a = useSlots(), l = inject(bl, {}), n = r(toRef(t, "active")), u = computed(() => !_e(a.default)), f = computed(() => ({
...
var ca = kt("", [], { type: [Boolean, String, Number], default: false });
var fa = kt("offset", [""], { type: [String, Number], default: null });
var va = kt("order", [""], { type: [String, Number], default: null });
...
var tt = Ae(Go, [["render", Uo]]);
var Xe = { autoHide: true, delay: 5e3, noCloseButton: false, pos: "top-right", value: true };
var ma = class {
  constructor(t) {
    ve(this, "vm");
...
var hl = defineComponent({
  ...
  setup(e, { emit: t, slots: a }) {
    r(toRef(e, "animation"));
    const l = r(toRef(e, "isStatus")), n = r(toRef(e, "autoHide")), u = r(toRef(e, "noCloseButton")), f = r(toRef(e, "noFade")), d = r(toRef(e, "noHoverPause"));
    r(toRef(e, "solid")), r(toRef(e, "static"));
    const v = r(toRef(e, "modelValue")), p = ref(false), $ = ref(false), m = ref(false), B = computed(() => ({
    ...
    const k = () => {
      ...
      v.value && (T = b = 0, k(), $.value = true, it(() => {
        m.value = false;
      }));
    }, R = () => {
      k(), t("update:modelValue", true), T = b = 0, $.value = false, nextTick(() => {
        it(() => {
          m.value = true;
        });
      });
    ...
    return () => {
      const Q = () => {
        ...
        oe ? Y.push(h(oe)) : e.title && Y.push(h("strong", { class: "me-auto" }, e.title)), !u.value && Y.length !== 0 && Y.push(
          h(Qe, {
            class: ["btn-close"],
            onClick: () => {
              C();
  ...
  setup(e) {
    ...
    return (u, f) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList((d = e.instance) == null ? void 0 : d.toasts(e.position).value, (v) => (openBlock(), createBlock(hl, {
          id: v.options.id,
          key: v.options.id,
  ...
  setup(e, { slots: t, expose: a }) {
    ...
    return onMounted(() => {
      ...
      return n == null || n.containerPositions.value.forEach((v) => {
        f.push(h(Dt, { key: v, instance: n, position: v }));
...
var yl = defineComponent({
  ...
  setup(e, { expose: t, emit: a }) {
    const l = e, n = $e(toRef(l, "id"), "dropdown"), u = r(toRef(l, "block")), f = r(toRef(l, "dark")), d = r(toRef(l, "dropup")), v = r(toRef(l, "dropright")), p = r(toRef(l, "isNav")), $ = r(toRef(l, "dropleft")), m = r(toRef(l, "right")), B = r(toRef(l, "split")), V = r(toRef(l, "noCaret")), T = ref(), b = ref(), k = ref(), y = computed(() => ({
      "d-grid": u.value,
      ...
      "aria-expanded": B.value ? void 0 : false,
      ...
      var I;
      (I = k.value) == null || I.hide();
    }, N = (I) => {
      B.value && a("click", I);
    };
    return he(T, "show.bs.dropdown", () => a("show")), he(T, "shown.bs.dropdown", () => a("shown")), he(T, "hide.bs.dropdown", () => a("hide")), he(T, "hidden.bs.dropdown", () => a("hidden")), onMounted(() => {
      var I;
      k.value = new Dropdown((I = b.value) == null ? void 0 : I.$el, {
      ...
      unref(B) ? (openBlock(), createBlock(nt, mergeProps({
        key: 0,
        variant: e.variant,
        size: e.size,
        disabled: e.disabled
      ...
      createBaseVNode("ul", {
        class: normalizeClass(["dropdown-menu", unref(R)]),
...
var ps = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    return ($, m) => (openBlock(), createElementBlock("li", {
      role: "presentation",
      class: normalizeClass($.$attrs.class)
    }, [
...
var Ht = defineComponent({
  ...
  setup(e) {
    ...
    return (v, p) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), mergeProps({ class: unref(f) }, unref(d)), {
      default: withCtx(() => [
        renderSlot(v.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
...
var $l = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = useSlots(), n = $e(toRef(a, "id"), "form-check"), u = r(
      toRef(a, "indeterminate")
    ), f = r(toRef(a, "autofocus")), d = r(toRef(a, "plain")), v = r(toRef(a, "button")), p = r(toRef(a, "switch")), $ = r(toRef(a, "disabled")), m = r(toRef(a, "inline")), B = r(toRef(a, "required")), V = r(toRef(a, "state")), T = ref(null), b = ref(false), k = computed(() => !_e(l.default)), y = computed({
      get: () => a.uncheckedValue ? Array.isArray(a.modelValue) ? a.modelValue.indexOf(a.value) > -1 : a.modelValue === a.value : a.modelValue,
      set: (N) => {
        let I = N;
        Array.isArray(a.modelValue) ? a.uncheckedValue && (I = a.modelValue, N ? (I.indexOf(a.uncheckedValue) > -1 && I.splice(I.indexOf(a.uncheckedValue), 1), I.push(a.value)) : (I.indexOf(a.value) > -1 && I.splice(I.indexOf(a.value), 1), I.push(a.uncheckedValue))) : I = N ? a.value : a.uncheckedValue, t("input", I), t("update:modelValue", I), t("change", I);
      }
    }), C = computed(() => Array.isArray(a.modelValue) ? a.modelValue.indexOf(a.value) > -1 : JSON.stringify(a.modelValue) === JSON.stringify(a.value)), R = reactive({
      plain: toRef(d, "value"),
    ...
    }), D = Ka(R), F = Xa(R), _ = Ja(R);
    return onMounted(() => {
      f.value && T.value.focus();
    }), (N, I) => (openBlock(), createElementBlock("div", {
      class: normalizeClass(unref(D))
    }, [
      withDirectives(createBaseVNode("input", mergeProps({ id: unref(n) }, N.$attrs, {
        ref_key: "input",
        ref: T,
        "onUpdate:modelValue": I[0] || (I[0] = (w) => isRef(y) ? y.value = w : null),
        class: unref(F),
        type: "checkbox",
        disabled: unref($),
        ...
        onFocus: I[1] || (I[1] = (w) => b.value = true),
        onBlur: I[2] || (I[2] = (w) => b.value = false)
      }), null, 16, Vs), [
...
var Os = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = useSlots(), n = "BFormCheckbox", u = $e(toRef(a, "id"), "checkbox"), f = $e(toRef(a, "name"), "checkbox");
    r(toRef(a, "autofocus"));
    const d = r(toRef(a, "buttons")), v = r(toRef(a, "disabled"));
    r(toRef(a, "plain"));
    const p = r(toRef(a, "required")), $ = r(toRef(a, "stacked")), m = r(toRef(a, "state")), B = r(toRef(a, "switches")), V = r(toRef(a, "validated")), T = computed({
      get: () => a.modelValue,
      set: (R) => {
        if (JSON.stringify(R) === JSON.stringify(a.modelValue))
          return;
        const D = a.options.filter(
          (F) => R.map((_) => JSON.stringify(_)).includes(JSON.stringify(typeof F == "string" ? F : F[a.valueField]))
    ...
    return (R, D) => (openBlock(), createElementBlock("div", mergeProps(unref(y), {
      id: unref(u),
      role: "group",
      class: [unref(C), "bv-no-focus-ring"],
      tabindex: "-1"
    }), [
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(b), (F, _) => (openBlock(), createBlock($l, mergeProps({
        key: _,
        modelValue: unref(T),
        "onUpdate:modelValue": D[0] || (D[0] = (N) => isRef(T) ? T.value = N : null)
      }, F.props), {
        default: withCtx(() => [
...
var Ls = kl.map((e) => `${e}:not([disabled])`).join();
var zs = [...kl, "a", "button", "label"];
var Ns = "label";
...
var qs = defineComponent({
  ...
  setup(e, { attrs: t }) {
    const a = r(toRef(e, "disabled")), l = r(toRef(e, "labelSrOnly")), n = r(toRef(e, "state")), u = r(toRef(e, "tooltip")), f = r(toRef(e, "validated")), d = r(toRef(e, "floating")), v = null, p = ["xs", "sm", "md", "lg", "xl"], $ = (_, N) => p.reduce((I, w) => {
      const P = sa(w === "xs" ? "" : w, `${N}Align`), z = _[P] || null;
      return z && (w === "xs" ? I.push(`text-${z}`) : I.push(`text-${w}-${z}`)), I;
    }, []), m = (_, N) => p.reduce((I, w) => {
      const P = sa(w === "xs" ? "" : w, `${N}Cols`);
      let z = _[P];
      return z = z === "" ? true : z || false, typeof z != "boolean" && z !== "auto" && (z = et(z, 0), z = z > 0 ? z : false), z && (w === "xs" ? I.cols = z : I[w || (typeof z == "boolean" ? "col" : "cols")] = z), I;
    }, {}), B = ref(), V = (_, N = null) => {
      if (Na && e.labelFor) {
        const I = Ma(`#${bn(e.labelFor)}`, B);
        if (I) {
          const w = "aria-describedby", P = (_ || "").split(dt), z = (N || "").split(dt), Q = (Xt(I, w) || "").split(dt).filter((Y) => !z.includes(Y)).concat(P).filter((Y, oe, K) => K.indexOf(Y) === oe).filter((Y) => Y).join(" ").trim();
          Q ? An(I, w, Q) : xn(I, w);
        }
      }
    }, T = computed(() => m(e, "content")), b = computed(() => $(e, "label")), k = computed(() => m(e, "label")), y = computed(
    ...
    return watch(
      ...
      onLegendClick: (_) => {
        if (e.labelFor)
          return;
        const { target: N } = _, I = N ? N.tagName : "";
        if (zs.indexOf(I) !== -1)
          return;
  ...
  render() {
    ...
    if (u || this.isHorizontal) {
      ...
      if (this.labelSrOnlyBoolean)
        u && (n = h(
          ...
          u
        )), this.isHorizontal ? n = h(tt, this.labelColProps, { default: () => n }) : n = h("div", {}, [n]);
      else {
        const F = {
        ...
        this.isHorizontal ? n = h(tt, F, { default: () => u }) : n = h(D, F, u);
      }
    }
    let d = null;
    ...
    this.isHorizontal && (C = h(tt, { ref: "content", ...this.contentColProps }, { default: () => y }));
    const R = {
      class: [
        "mb-3",
        this.stateClass,
    ...
    return this.isHorizontal && !l ? h(ft, R, { default: () => [n, C] }) : h(
      l ? "fieldset" : "div",
      R,
...
var Ms = defineComponent({
  ...
  setup(e, { emit: t }) {
    const { input: a, computedId: l, computedAriaInvalid: n, onInput: u, onChange: f, onBlur: d, focus: v, blur: p } = al(e, t), $ = ref(false), m = computed(() => {
    ...
    return {
      ...
      blur: p,
      highlight: () => {
        $.value !== true && ($.value = true, setTimeout(() => {
          $.value = false;
        }, 2e3));
      }
    };
...
var Cl = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = useSlots(), n = $e(toRef(a, "id"), "form-check"), u = r(toRef(a, "autofocus")), f = r(toRef(a, "plain")), d = r(toRef(a, "button")), v = r(toRef(a, "switch")), p = r(toRef(a, "disabled")), $ = r(toRef(a, "inline")), m = r(toRef(a, "required")), B = r(toRef(a, "state")), V = ref(null), T = ref(false), b = computed({
      get: () => Array.isArray(a.modelValue) ? a.modelValue[0] : a.modelValue,
      set: (_) => {
        const N = _ ? a.value : false, I = Array.isArray(a.modelValue) ? [N] : N;
        t("input", I), t("change", I), t("update:modelValue", I);
      }
    }), k = computed(() => Array.isArray(a.modelValue) ? (a.modelValue || []).find((_) => _ === a.value) : JSON.stringify(a.modelValue) === JSON.stringify(a.value)), y = computed(() => !_e(l.default)), C = reactive({
      plain: toRef(f, "value"),
    ...
    return onMounted(() => {
      ...
      withDirectives(createBaseVNode("input", mergeProps({ id: unref(n) }, _.$attrs, {
        ...
        onFocus: N[1] || (N[1] = (I) => T.value = true),
        onBlur: N[2] || (N[2] = (I) => T.value = false)
      }), null, 16, Ws), [
        [vModelRadio, unref(b)]
      ]),
      unref(y) || !unref(f) ? (openBlock(), createElementBlock("label", {
        key: 0,
        for: unref(n),
        class: normalizeClass([unref(F), { active: unref(k), focus: T.value }])
      }, [
...
var Zs = defineComponent({
  ...
  emits: ["input", "update:modelValue", "change"],
  setup(e, { emit: t }) {
    const a = e, l = useSlots(), n = "BFormRadio", u = $e(toRef(a, "id"), "radio"), f = $e(toRef(a, "name"), "checkbox");
    r(toRef(a, "autofocus"));
    const d = r(toRef(a, "buttons")), v = r(toRef(a, "disabled"));
    r(toRef(a, "plain"));
    const p = r(toRef(a, "required")), $ = r(toRef(a, "stacked")), m = r(toRef(a, "state")), B = r(toRef(a, "validated")), V = computed({
      get: () => a.modelValue,
      set: (C) => {
    ...
    return (C, R) => (openBlock(), createElementBlock("div", mergeProps(unref(k), {
      id: unref(u),
      role: "radiogroup",
      class: [unref(y), "bv-no-focus-ring"],
      tabindex: "-1"
    }), [
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(T), (D, F) => (openBlock(), createBlock(Cl, mergeProps({
        key: F,
        modelValue: unref(V),
        "onUpdate:modelValue": R[0] || (R[0] = (_) => isRef(V) ? V.value = _ : null)
      }, D.props), {
        default: withCtx(() => [
          D.html ? (openBlock(), createElementBlock("span", {
            key: 0,
            innerHTML: D.html
          }, null, 8, Js)) : (openBlock(), createElementBlock("span", {
            key: 1,
            textContent: toDisplayString(D.text)
          }, null, 8, Ys))
        ]),
        _: 2
      }, 1040, ["modelValue"]))), 128))
...
var Sl = defineComponent({
  ...
  setup(e) {
    ...
    return (l, n) => (openBlock(), createElementBlock("optgroup", { label: e.label }, [
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(a), (u, f) => (openBlock(), createBlock(ea, mergeProps({
        key: f,
        value: u.value,
        disabled: u.disabled
      }, l.$attrs, {
...
var ai = defineComponent({
  ...
  emits: ["input", "update:modelValue", "change"],
  setup(e, { expose: t, emit: a }) {
    const l = e, n = $e(toRef(l, "id"), "input"), u = r(toRef(l, "autofocus")), f = r(toRef(l, "disabled")), d = r(toRef(l, "multiple")), v = r(toRef(l, "plain")), p = r(toRef(l, "required")), $ = r(toRef(l, "state")), m = ref(), B = computed(() => ({
    ...
    return onMounted(R), onActivated(R), t({
      blur: C,
      focus: y
    }), (D, F) => withDirectives((openBlock(), createElementBlock("select", mergeProps({
      id: unref(n),
      ref_key: "input",
      ref: m
    }, D.$attrs, {
      "onUpdate:modelValue": F[0] || (F[0] = (_) => isRef(k) ? k.value = _ : null),
      class: unref(B),
      name: e.name,
      form: e.form || void 0,
      ...
      renderSlot(D.$slots, "first"),
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(b), (_, N) => (openBlock(), createElementBlock(Fragment, { key: N }, [
        Array.isArray(_.options) ? (openBlock(), createBlock(Sl, {
          key: 0,
          label: _.label,
          options: _.options
        }, null, 8, ["label", "options"])) : (openBlock(), createBlock(ea, {
          key: 1,
          value: _.value,
          disabled: _.disabled,
...
var wl = defineComponent({
  ...
  emits: ["remove"],
  setup(e, { emit: t }) {
    const a = e, l = useSlots(), n = $e(toRef(a, "id")), u = r(toRef(a, "disabled")), f = r(toRef(a, "noRemove")), d = r(toRef(a, "pill")), v = computed(
      () => {
        var m, B, V;
        return (V = ((B = (m = l.default) == null ? void 0 : m.call(l)[0].children) == null ? void 0 : B.toString()) || a.title) != null ? V : "";
      }
    ), p = computed(() => `${n.value}taglabel__`), $ = computed(() => [
      `bg-${a.variant}`,
      {
    ...
    return (m, B) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      id: unref(n),
      title: unref(v),
      class: normalizeClass(["badge b-form-tag d-inline-flex align-items-center mw-100", unref($)]),
      ...
      default: withCtx(() => [
        ...
        !unref(u) && !unref(f) ? (openBlock(), createBlock(Qe, {
          key: 0,
          ...
          "aria-controls": e.id,
          onClick: B[0] || (B[0] = (V) => t("remove", unref(v)))
...
var pi = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = $e(), n = r(toRef(a, "addOnChange")), u = r(toRef(a, "autofocus")), f = r(toRef(a, "disabled")), d = r(toRef(a, "noAddOnEnter")), v = r(toRef(a, "noOuterFocus")), p = r(toRef(a, "noTagRemove")), $ = r(toRef(a, "removeOnDelete")), m = r(toRef(a, "required")), B = r(toRef(a, "state")), V = r(toRef(a, "tagPills")), T = ref(null), b = computed(() => a.inputId || `${l.value}input__`), k = ref(a.modelValue), y = ref(""), C = ref(false), R = ref(false), D = ref(""), F = ref([]), _ = ref([]), N = ref([]), I = computed(() => ({
    ...
    ), z = computed(() => k.value.length === a.limit), Q = computed(() => !P.value && !w.value), Y = computed(() => ({
    ...
    const oe = () => {
      ...
      f.value || v.value || (R.value = true, t("focus", x));
    }, ee = (x) => {
      R.value = false, t("blur", x);
    }, me = (x) => {
      var te, le;
      const j = typeof x == "string" ? x : x.target.value;
      if (C.value = false, ((te = a.separator) == null ? void 0 : te.includes(j.charAt(0))) && j.length > 0) {
      ...
      F.value = a.tagValidator(j) && !w.value ? [j] : [], _.value = a.tagValidator(j) ? [] : [j], N.value = w.value ? [j] : [], t("tag-state", F.value, _.value, N.value);
    }, ge = (x) => {
      ...
      (x.key === "Backspace" || x.key === "Delete") && $.value && y.value === "" && C.value && k.value.length > 0 ? ye(k.value[k.value.length - 1]) : C.value = true;
    }, se = (x) => {
      var te;
      if (x = (x || y.value).trim(), x === "" || w.value || !a.tagValidator(x) || a.limit && z.value)
        return;
      const j = [...a.modelValue, x];
      y.value = "", C.value = true, t("update:modelValue", j), t("input", j), (te = T.value) == null || te.focus();
    }, ye = (x) => {
      var te;
    ...
    return onMounted(() => {
      oe(), a.modelValue.length > 0 && (C.value = true);
    }), onActivated(() => oe()), (x, j) => (openBlock(), createElementBlock("div", {
      id: unref(l),
      class: normalizeClass(["b-form-tags form-control h-auto", unref(I)]),
      role: "group",
      tabindex: "-1",
      onFocusin: K,
      ...
      createBaseVNode("div", {
        ...
        "aria-atomic": "true",
        class: "visually-hidden"
      }, " (" + toDisplayString(e.tagRemovedLabel) + ") " + toDisplayString(D.value), 9, si),
      renderSlot(x.$slots, "default", normalizeProps(guardReactiveProps(unref(Y))), () => [
        createBaseVNode("ul", {
          id: `${unref(l)}tag_list__`,
          class: "b-form-tags-list list-unstyled mb-0 d-flex flex-wrap align-items-center"
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(k.value, (te, le) => renderSlot(x.$slots, "tag", normalizeProps(mergeProps({ key: le }, { tag: te, tagClass: e.tagClass, tagVariant: e.tagVariant, tagPills: unref(V), removeTag: ye })), () => [
            createVNode(wl, {
          ...
          createBaseVNode("li", {
            ...
            createBaseVNode("div", ui, [
              ...
              unref(Q) ? (openBlock(), createElementBlock("button", {
                ...
                style: { "font-size": "90%" },
                disabled: unref(f) || y.value.length === 0 || unref(z),
                onClick: j[0] || (j[0] = (te) => se(y.value))
              }, [
                renderSlot(x.$slots, "add-button-text", {}, () => [
      ...
      e.name ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(k.value, (te, le) => (openBlock(), createElementBlock("input", {
        key: le,
        type: "hidden",
        name: e.name,
        value: te
...
var hi = defineComponent({
  ...
  emits: ["update:modelValue", "change", "blur", "input"],
  setup(e, { emit: t }) {
    const { input: a, computedId: l, computedAriaInvalid: n, onInput: u, onChange: f, onBlur: d, focus: v, blur: p } = al(e, t), $ = r(toRef(e, "noResize")), m = computed(() => ({
...
var ta = defineComponent({
  ...
  setup(e) {
    ...
    return (l, n) => unref(a) ? (openBlock(), createBlock(Tl, { key: 0 }, {
      default: withCtx(() => [
        renderSlot(l.$slots, "default")
      ]),
      _: 3
...
var Ai = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createBlock(ta, { "is-text": e.isText }, {
      default: withCtx(() => [
        renderSlot(t.$slots, "default")
      ]),
      _: 3
...
var Ii = defineComponent({
  ...
  setup(e) {
    ...
    return provide(_l, {
      numbered: l.value
    }), (f, d) => (openBlock(), createBlock(resolveDynamicComponent(unref(u)), {
...
var Fi = defineComponent({
  ...
  setup(e) {
    const t = e, a = useAttrs(), l = inject(_l, null), n = r(toRef(t, "action")), u = r(toRef(t, "active")), f = r(toRef(t, "button")), d = r(toRef(t, "disabled")), v = computed(() => !f.value && (!!t.href || !!t.to)), p = computed(
      ...
      const V = {};
      return f.value && ((!a || !a.type) && (V.type = "button"), d.value && (V.disabled = true)), V;
    });
...
var Pi = ["id", "aria-labelledby", "aria-describedby", "onKeyup"];
var Oi = ["id"];
var Li = {
  inheritAttrs: false
};
var zi = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = useSlots(), n = $e(toRef(a, "id"), "modal"), u = r(toRef(a, "busy")), f = r(toRef(a, "lazy")), d = r(toRef(a, "cancelDisabled")), v = r(toRef(a, "centered")), p = r(toRef(a, "hideBackdrop")), $ = r(toRef(a, "hideFooter")), m = r(toRef(a, "hideHeader")), B = r(toRef(a, "hideHeaderClose")), V = r(toRef(a, "modelValue")), T = r(toRef(a, "noCloseOnBackdrop")), b = r(toRef(a, "noCloseOnEsc")), k = r(toRef(a, "noFade")), y = r(toRef(a, "noFocus")), C = r(toRef(a, "okDisabled")), R = r(toRef(a, "okOnly")), D = r(toRef(a, "scrollable")), F = r(toRef(a, "titleSrOnly")), _ = r(toRef(a, "static")), N = ref(false), I = ref(null), w = ref(false), P = computed(() => [
      a.modalClass,
      {
        fade: !k.value,
        show: N.value
      }
    ]), z = computed(() => !_e(l["header-close"])), Q = computed(() => [
      a.dialogClass,
      {
    ...
    ]), ee = computed(() => d.value || u.value), me = computed(() => C.value || u.value), ge = () => t("update:modelValue", false), Te = (le) => {
      !b.value && V.value && le.key === "Escape" && ge();
    }, se = () => t("show"), ye = () => {
      N.value = true, t("shown"), f.value === true && (w.value = true);
    }, x = () => t("hide"), j = () => {
      N.value = false;
    }, te = () => {
      t("hidden"), f.value === true && (w.value = false);
    };
    return watch(
      () => V.value,
      (le) => {
        le === true && !y.value && nextTick(() => {
          I.value !== null && I.value.focus();
        });
      }
    ), (le, fe) => (openBlock(), createBlock(Teleport, {
      to: "body",
      disabled: unref(_)
    }, [
      createVNode(wt, {
        ...
        default: withCtx(() => [
          withDirectives(createBaseVNode("div", mergeProps({
            ...
            createBaseVNode("div", {
              ...
              !unref(f) || unref(f) && w.value || unref(f) && unref(V) === true ? (openBlock(), createElementBlock("div", {
                ...
                unref(m) ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: normalizeClass(["modal-header", unref(oe)])
                }, [
                  renderSlot(le.$slots, "header", {}, () => [
                    (openBlock(), createBlock(resolveDynamicComponent(e.titleTag), {
                      id: `${unref(n)}-label`,
                      class: normalizeClass(["modal-title", unref(be)])
                    }, {
                      default: withCtx(() => [
                        renderSlot(le.$slots, "title", {}, () => [
                          createTextVNode(toDisplayString(e.title), 1)
                        ])
                      ]),
                      _: 3
                    ...
                    unref(B) ? createCommentVNode("", true) : (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                      unref(z) ? (openBlock(), createElementBlock("button", {
                        key: 0,
                        type: "button",
                        "data-bs-dismiss": "modal",
                        onClick: fe[0] || (fe[0] = (we) => ge())
                      }, [
                        renderSlot(le.$slots, "header-close")
                      ])) : (openBlock(), createBlock(Qe, {
                        key: 1,
                ...
                unref($) ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", {
                  key: 1,
                  class: normalizeClass(["modal-footer", unref(K)])
                }, [
                  renderSlot(le.$slots, "footer", {}, () => [
                    renderSlot(le.$slots, "cancel", {}, () => [
                      unref(R) ? createCommentVNode("", true) : (openBlock(), createBlock(nt, {
                        key: 0,
                        type: "button",
                        class: "btn",
                        disabled: unref(ee),
            ...
            unref(p) ? createCommentVNode("", true) : renderSlot(le.$slots, "backdrop", { key: 0 }, () => [
              createBaseVNode("div", {
                class: "modal-backdrop fade show",
                onClick: fe[4] || (fe[4] = (we) => !unref(T) && ge())
              })
            ])
          ], 16, Pi), [
            [vShow, unref(V)]
...
var Ni = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "cardHeader")), l = r(toRef(t, "fill")), n = r(toRef(t, "justified")), u = r(toRef(t, "pills")), f = r(toRef(t, "small")), d = r(toRef(t, "tabs")), v = r(toRef(t, "vertical")), p = st(toRef(t, "align")), $ = computed(() => ({
      "nav-tabs": d.value,
    ...
    return (m, B) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      class: normalizeClass(["nav", unref($)])
    }, {
      default: withCtx(() => [
        renderSlot(m.$slots, "default")
      ]),
...
var Ei = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    return (u, f) => (openBlock(), createBlock(Bl, mergeProps(unref(l), {
      class: "d-flex",
...
var Hi = { class: "nav-item" };
function Ri(e, t, a, l, n, u) {
  const f = resolveComponent("b-link");
  return openBlock(), createElementBlock("li", Hi, [
...
var qi = Ae(Di, [["render", Ri]]);
var Mi = { class: "nav-item dropdown" };
var ji = defineComponent({
  ...
  setup(e) {
    const t = e;
    return (a, l) => (openBlock(), createElementBlock("li", Mi, [
      createVNode(yl, mergeProps(t, { "is-nav": "" }), createSlots({ _: 2 }, [
        renderList(a.$slots, (n, u, f) => ({
          name: u,
          fn: withCtx((d) => [
            renderSlot(a.$slots, u, normalizeProps(guardReactiveProps(d || {})))
          ])
        }))
      ]), 1040)
    ]));
...
var Ui = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createElementBlock("li", Gi, [
      renderSlot(t.$slots, "default", {}, () => [
        createTextVNode(toDisplayString(e.text), 1)
      ])
    ]));
...
var Ki = defineComponent({
  ...
  setup(e) {
    const t = computed(() => lt(e)), a = computed(
      () => t.value ? Ve : e.tag
    );
    return {
      computedLinkProps: computed(
...
var Yi = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "fill")), l = r(toRef(t, "justified")), n = r(toRef(t, "small")), u = st(toRef(t, "align")), f = computed(() => ({
      "nav-fill": a.value,
...
var Zi = createBaseVNode("span", { class: "navbar-toggler-icon" }, null, -1);
var Qi = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    return (d, v) => withDirectives((openBlock(), createElementBlock("button", mergeProps({
      ...
      [unref(Zt), unref(l) ? void 0 : e.target]
    ]);
  }
});
var er = ["data-bs-backdrop", "data-bs-scroll"];
var tr = {
  key: 0,
...
var or = defineComponent({
  ...
  emits: ["update:modelValue", "show", "shown", "hide", "hidden"],
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "modelValue")), n = r(toRef(a, "bodyScrolling")), u = r(toRef(a, "backdrop")), f = r(toRef(a, "noHeaderClose")), d = r(toRef(a, "noHeader")), v = useSlots(), p = ref(), $ = ref(), m = computed(() => !_e(v.footer)), B = computed(() => [`offcanvas-${a.placement}`]), V = () => {
      t("show"), t("update:modelValue", true);
    }, T = () => {
      t("hide"), t("update:modelValue", false);
    };
    return watch(
      ...
      var b;
      $.value = new Offcanvas(p.value), l.value && ((b = $.value) == null || b.show(p.value));
    }), (b, k) => (openBlock(), createElementBlock("div", {
      ref_key: "element",
      ref: p,
      class: normalizeClass(["offcanvas", unref(B)]),
      tabindex: "-1",
      "aria-labelledby": "offcanvasLabel",
      "data-bs-backdrop": unref(u),
      "data-bs-scroll": unref(n)
    }, [
      unref(d) ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", tr, [
        renderSlot(b.$slots, "header", normalizeProps(guardReactiveProps({ visible: unref(l), placement: e.placement, hide: T })), () => [
          ...
          unref(f) ? createCommentVNode("", true) : (openBlock(), createBlock(Qe, {
            key: 0,
            class: "text-reset",
      ...
      unref(m) ? (openBlock(), createElementBlock("div", nr, [
...
var sr = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = { top: 0, left: 0, bottom: 0, right: 0 }, n = r(toRef(a, "fixed")), u = r(toRef(a, "noCenter")), f = r(toRef(a, "noWrap")), d = r(toRef(a, "show")), v = r(toRef(a, "spinnerSmall")), p = computed(
      () => a.rounded === true || a.rounded === "" ? "rounded" : a.rounded === false ? "" : `rounded-${a.rounded}`
    ), $ = computed(
      () => a.variant && !a.bgColor ? `bg-${a.variant}` : ""
    ), m = computed(() => d.value ? "true" : null), B = computed(() => ({
    ...
    ]), b = computed(() => [$.value, p.value]), k = computed(() => ({
      ...l,
      opacity: a.opacity,
    ...
    return (C, R) => (openBlock(), createBlock(resolveDynamicComponent(e.wrapTag), {
            ...
            unref(d) ? (openBlock(), createBlock(resolveDynamicComponent(e.overlayTag), {
              ...
              default: withCtx(() => [
                ...
                createBaseVNode("div", {
                  ...
                  renderSlot(C.$slots, "overlay", normalizeProps(guardReactiveProps(unref(B))), () => [
                    createVNode(St, normalizeProps(guardReactiveProps(unref(B))), null, 16)
                  ])
                ], 4)
              ]),
              _: 3
...
var Al = 0;
var Oe = 3;
var rr = "ellipsis-text";
var ur = "first-text";
var dr = "last-text";
var cr = "next-text";
var fr = "page";
var vr = "prev-text";
var ha = (e) => Math.max(Le(e) || Vl, 1);
var ya = (e) => Math.max(Le(e) || Al, 0);
var mr = (e, t) => {
  const a = Le(e) || 1;
...
var br = defineComponent({
  ...
  setup(e, { emit: t, slots: a }) {
    const l = r(toRef(e, "disabled")), n = r(toRef(e, "firstNumber")), u = r(toRef(e, "hideEllipsis")), f = r(toRef(e, "hideGotoEndButtons")), d = r(toRef(e, "lastNumber")), v = r(toRef(e, "pills")), p = computed(
      () => e.align === "fill" ? "start" : e.align
    ), $ = st(toRef(p, "value")), m = computed(
      () => Math.ceil(ya(e.totalRows) / ha(e.perPage))
    ), B = computed(() => {
      let F;
      return m.value - e.modelValue + 2 < e.limit && e.limit > Oe ? F = m.value - T.value + 1 : F = e.modelValue - Math.floor(T.value / 2), F < 1 ? F = 1 : F > m.value - T.value && (F = m.value - T.value + 1), e.limit <= Oe && d.value && m.value === F + T.value - 1 && (F = Math.max(F - 1, 1)), F;
    }), V = computed(() => {
      const F = m.value - e.modelValue;
      let _ = false;
      return F + 2 < e.limit && e.limit > Oe ? e.limit > Oe && (_ = true) : e.limit > Oe && (_ = !!(!u.value || n.value)), B.value <= 1 && (_ = false), _ && n.value && B.value < 4 && (_ = false), _;
    }), T = computed(() => {
      let F = e.limit;
      return m.value <= e.limit ? F = m.value : e.modelValue < e.limit - 1 && e.limit > Oe ? ((!u.value || d.value) && (F = e.limit - (n.value ? 0 : 1)), F = Math.min(F, e.limit)) : m.value - e.modelValue + 2 < e.limit && e.limit > Oe ? (!u.value || n.value) && (F = e.limit - (d.value ? 0 : 1)) : e.limit > Oe && (F = e.limit - (u.value ? 0 : 2)), F;
    }), b = computed(() => {
      const F = m.value - T.value;
      let _ = false;
      e.modelValue < e.limit - 1 && e.limit > Oe ? (!u.value || d.value) && (_ = true) : e.limit > Oe && (_ = !!(!u.value || d.value)), B.value > F && (_ = false);
      const N = B.value + T.value - 1;
      return _ && d.value && N > m.value - 3 && (_ = false), _;
    }), k = reactive({
      ...
      if (_ === e.modelValue)
        return;
      const { target: N } = F, I = new yt("page-click", {
        cancelable: true,
        vueTarget: this,
        target: N
      });
      t("page-click", I, _), !I.defaultPrevented && t("update:modelValue", _);
    }, C = computed(() => e.size ? `pagination-${e.size}` : ""), R = computed(() => v.value ? "b-pagination-pills" : "");
    watch(
      () => e.modelValue,
      (F) => {
        const _ = mr(F, m.value);
        _ !== e.modelValue && t("update:modelValue", _);
      }
    ), watch(k, (F, _) => {
      F != null && (_.pageSize !== F.pageSize && _.totalRows === F.totalRows || _.numberOfPages !== F.numberOfPages && e.modelValue > _.numberOfPages) && t("update:modelValue", 1);
    });
    const D = computed(() => {
      const F = [];
      for (let _ = 0; _ < T.value; _++)
        F.push({ number: B.value + _, classes: null });
      return F;
    });
    return () => {
      const F = [], _ = D.value.map((K) => K.number), N = (K) => K === e.modelValue, I = e.modelValue < 1, w = e.align === "fill", P = (K, be, ee, me, ge, Te) => {
        const se = l.value || N(Te) || I || K < 1 || K > m.value, ye = K < 1 ? 1 : K > m.value ? m.value : K, x = { disabled: se, page: ye, index: ye - 1 }, j = Fe(ee, x, a) || me || "";
        return h(
          "li",
          {
            class: [
        ...
        const ee = N(K.number) && !I, me = l.value ? null : ee || I && be === 0 ? "0" : "-1", ge = {
          active: ee,
          disabled: l.value,
          page: K.number,
          index: K.number - 1,
          content: K.number
        }, Te = Fe(fr, ge, a) || K.number, se = h(
          l.value ? "span" : "button",
          {
      ...
      F.push(Y), n.value && _[0] !== 1 && F.push(Q({ number: 1 }, 0)), V.value && F.push(z(false)), D.value.forEach((K, be) => {
        const ee = V.value && n.value && _[0] !== 1 ? 1 : 0;
        F.push(Q(K, be + ee));
      }), b.value && F.push(z(true)), d.value && _[_.length - 1] !== m.value && F.push(Q({ number: m.value }, -1));
      const oe = P(
        e.modelValue + 1,
        e.labelNextPage,
        cr,
...
var gr = defineComponent({
  ...
  setup(e) {
    ...
    return (p, $) => (openBlock(), createBlock(ml, { "img-bottom": e.imgBottom }, createSlots({
      default: withCtx(() => [
      ...
      unref(n) ? void 0 : {
        ...
        fn: withCtx(() => [
          renderSlot(p.$slots, "footer", {}, () => [
            unref(a) ? (openBlock(), createBlock(Ie, normalizeProps(mergeProps({ key: 1 }, unref(d))), null, 16)) : (openBlock(), createBlock(xl, normalizeProps(mergeProps({ key: 0 }, unref(d))), null, 16))
          ])
        ]),
        key: "2"
      }
...
var Tt = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "captionTop")), l = r(toRef(t, "borderless")), n = r(toRef(t, "bordered")), u = r(toRef(t, "dark")), f = r(toRef(t, "hover")), d = r(toRef(t, "small")), v = r(toRef(t, "striped")), p = r(toRef(t, "stickyHeader")), $ = computed(() => [
      "table",
      "b-table",
      {
    ...
    return (B, V) => e.responsive ? (openBlock(), createElementBlock("div", {
      key: 1,
...
var pr = defineComponent({
  ...
  setup(e) {
    ...
    })), p = r(toRef(t, "hideHeader")), $ = r(toRef(t, "showFooter"));
    return (m, B) => (openBlock(), createBlock(Tt, null, {
      default: withCtx(() => [
          ...
          createBaseVNode("thead", null, [
            createBaseVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n), (V, T) => (openBlock(), createElementBlock("th", { key: T }, [
                createVNode(Ie, normalizeProps(guardReactiveProps(unref(d))), null, 16)
              ]))), 128))
            ])
          ])
        ]),
        ...
        unref($) ? renderSlot(m.$slots, "tfoot", { key: 1 }, () => [
...
var yr = defineComponent({
  ...
  setup(e, { emit: t, slots: a }) {
    ...
    const l = r(toRef(e, "show")), n = r(toRef(e, "html")), u = r(toRef(e, "sanitize")), f = ref(), d = ref(), v = ref(), p = ref(), $ = ref(), m = computed(() => ({
      ...
      d.value = V(B(b)), d.value && (v.value = new Popover(d.value, {
    ...
    ), he(d, "show.bs.popover", () => t("show")), he(d, "shown.bs.popover", () => t("shown")), he(d, "hide.bs.popover", () => t("hide")), he(d, "hidden.bs.popover", () => t("hidden")), he(d, "inserted.bs.popover", () => t("inserted")), onMounted(() => {
      var b, k, y;
      nextTick(() => {
        T(e.target);
...
var Sr = Ae(yr, [["render", Cr]]);
var wr = ["aria-valuenow", "aria-valuemax"];
var Il = defineComponent({
  ...
  setup(e) {
    const t = e, a = inject(Fl), l = r(toRef(t, "animated")), n = r(toRef(t, "showProgress")), u = r(toRef(t, "showValue")), f = r(toRef(t, "striped")), d = computed(() => ({
    ...
    return (V, T) => (openBlock(), createElementBlock("div", {
      ...
      "aria-valuemin": "0",
      "aria-valuemax": e.max,
      style: normalizeStyle({ width: unref(B) })
    }, [
      renderSlot(V.$slots, "default", {}, () => [
...
var Tr = defineComponent({
  ...
  setup(e) {
    ...
    return provide(Fl, {
      ...
      renderSlot(d.$slots, "default", {}, () => [
        createVNode(Il, normalizeProps(guardReactiveProps(unref(f))), null, 16)
      ])
    ], 4));
  }
});
var Ba = kt("cols", [""], { type: [String, Number], default: null });
var _r = defineComponent({
  ...
  setup(e) {
    const t = r(toRef(e, "noGutters")), a = st(toRef(e, "alignH")), l = computed(() => Ga(e, Ba, "cols", "row-cols"));
    return {
      computedClasses: computed(() => [
        l.value,
        {
...
var Pr = defineComponent({
  ...
  setup(e) {
    ...
    return (n, u) => (openBlock(), createBlock(Tt, normalizeProps(guardReactiveProps(e.tableProps)), {
      default: withCtx(() => [
        unref(a) ? createCommentVNode("", true) : (openBlock(), createElementBlock("thead", Ir, [
          createBaseVNode("tr", null, [
        ...
        unref(l) ? (openBlock(), createElementBlock("tfoot", Fr, [
          createBaseVNode("tr", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(e.columns, (f, d) => (openBlock(), createElementBlock("th", { key: d }, [
              createVNode(vt)
            ]))), 128))
...
var zr = (e) => hn ? Lt(e) ? e : { capture: !!e || false } : !!(Lt(e) ? e.capture : e);
var Nr = (e, t, a, l) => {
...
var Dr = defineComponent({
  ...
  setup(e, { emit: t, slots: a }) {
    const l = ref(false), n = computed(() => 1), u = () => {
      t("change", d.value);
    }, f = ref(null), d = computed({
      get() {
    ...
    let v, p, $ = false;
    computed(() => e.inline && !e.vertical), computed(() => e.readonly && !e.disabled);
    const m = computed(() => at(e.step, wa)), B = computed(() => at(e.min, Ca)), V = computed(() => {
    ...
    }), R = computed(() => Math.pow(10, C.value || 0)), D = computed(() => {
      const { value: x } = d;
      ...
      () => e.formatterFn ? e.formatterFn : N()
    ), w = computed(() => ({
      role: "group",
      lang: F.value,
      tabindex: e.disabled ? null : "-1",
      title: e.ariaLabel
    })), P = computed(() => !Ne(e.modelValue) || !Ne(f.value)), z = computed(() => ({
      dir: _.value,
      spinId: n.value,
      ...
      if (!(e.disabled || e.readonly || te || le || fe) && xa.includes(j)) {
        if (rt(x, { propagation: false }), $)
          return;
        se(), [jt, Mt].includes(j) ? ($ = true, j === jt ? ee(x, Y) : j === Mt && ee(x, oe)) : j === zl ? Y(y.value) : j === Ll ? oe(y.value) : j === Ol ? d.value = B.value : j === Pl && (d.value = V.value);
      }
    }, be = (x) => {
      const { code: j, altKey: te, ctrlKey: le, metaKey: fe } = x;
      e.disabled || e.readonly || te || le || fe || xa.includes(j) && (rt(x, { propagation: false }), se(), $ = false, u());
    }, ee = (x, j) => {
      const { type: te } = x || {};
    ...
    const ge = (x) => {
      me(x) && x.type === "mouseup" && x.button || (rt(x, { propagation: false }), se(), Te(false), u());
    }, Te = (x) => {
      try {
        ka(x, [document.body, "mouseup", ge, false]), ka(x, [document.body, "touchend", ge, false]);
      } catch {
        return 0;
      }
    }, se = () => {
      ...
      const Ke = h(te, {
        ...
        !e.disabled && !e.readonly && (rt(S, { propagation: false }), Te(true), ee(S, x));
      };
      return h(
        "button",
        {
    ...
    return () => {
      ...
      const le = h(
        ...
        [
          h(
            "bdi",
            P.value ? I.value(d.value) : e.placeholder || ""
          )
        ]
      );
      return h(
...
var qr = () => {
  const e = (v, p) => {
  ...
  }, t = ref([]), a = (v, p, $, m) => (t.value = mt(p), "isFilterableTable" in m && m.isFilterableTable.value === true && $.filter && (t.value = u(t.value, $.filter, $.filterable)), "isSortable" in m && m.isSortable.value === true && (t.value = n(
    v,
    t.value,
    {
      key: $.sortBy,
    ...
    (m) => Object.entries(m).filter((B) => {
      const [V, T] = B;
      return !T || V[0] === "_" || $.length > 0 && !$.includes(V) ? false : (typeof T == "object" ? JSON.stringify(Object.values(T)) : typeof T == "string" ? T : T.toString()).toLowerCase().includes(p.toLowerCase());
    }).length > 0
  );
  return {
    normaliseFields: e,
...
var Mr = ["title", "abbr", "onClick"];
var jr = { class: "d-inline-flex flex-nowrap align-items-center gap-1" };
var Gr = { key: 1 };
var Ur = ["onClick", "onDblclick", "onMouseenter", "onMouseleave"];
var Wr = {
  key: 0,
...
var Kr = ["colspan"];
var Xr = ["colspan"];
var Jr = { class: "d-flex align-items-center justify-content-center gap-2" };
var Yr = createBaseVNode("strong", null, "Loading...", -1);
var Zr = {
  key: 1,
...
var ou = defineComponent({
  ...
  setup(e, { expose: t, emit: a }) {
    const l = e, n = useSlots(), u = qr(), f = r(toRef(l, "footClone")), d = r(toRef(l, "sortDesc")), v = r(toRef(l, "sortInternal")), p = r(toRef(l, "selectable")), $ = r(toRef(l, "stickySelect")), m = r(toRef(l, "labelStacked")), B = r(toRef(l, "busy")), V = r(toRef(l, "showEmpty")), T = r(toRef(l, "noProviderPaging")), b = r(toRef(l, "noProviderSorting")), k = r(toRef(l, "noProviderFiltering")), y = ref(B.value);
    ...
    const C = ref(/* @__PURE__ */ new Set([])), R = computed(() => C.value.size > 0), D = computed(() => ({
      ...
      "b-table-sort-desc": z.value && d.value === true,
      "b-table-sort-asc": z.value && d.value === false
    })), F = computed(() => ({
      bordered: l.bordered,
    ...
    })), _ = computed(() => u.normaliseFields(l.fields, l.items)), N = computed(
      () => _.value.length + (p.value ? 1 : 0)
    ), I = computed(() => l.filter !== void 0 && l.filter !== ""), w = computed(() => l.provider !== void 0), P = computed(
      () => p.value && (!!l.selectHead || n.selectHead !== void 0)
    ), z = computed(
      () => l.fields.filter((S) => typeof S == "string" ? false : S.sortable).length > 0
    ), Q = computed(() => z.value && v.value === true), Y = computed(() => {
      ...
      return S;
    }), oe = (S) => typeof S == "string" ? la(S) : S.label !== void 0 ? S.label : typeof S.key == "string" ? la(S.key) : S.key, K = (S, M, ie = false) => {
      ...
      if (!z.value)
        return;
      const M = typeof S == "string" ? S : S.key, ie = typeof S == "string" ? false : S.sortable;
      if (z.value === true && ie === true) {
        const H = !d.value;
      ...
      {
        "b-table-sortable-column": z.value && S.sortable,
      ...
      if (M === ie)
        return;
      const H = (El) => l.noProvider && l.noProvider.includes(El), Ce = !["currentPage", "perPage"].includes(S), re = ["currentPage", "perPage"].includes(S) && (H("paging") || T.value === true), Vt = ["filter"].includes(S) && (H("filtering") || k.value === true), je = ["sortBy", "sortDesc"].includes(S) && (H("sorting") || b.value === true);
    ...
    return watch(
      ...
      selectRow: Ke,
      unselectRow: _t
    }), (S, M) => (openBlock(), createBlock(Tt, normalizeProps(guardReactiveProps(unref(F))), {
      default: withCtx(() => {
        var ie;
        return [
          createBaseVNode("thead", null, [
            ...
            createBaseVNode("tr", null, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(_), (H) => (openBlock(), createElementBlock("th", mergeProps({
                key: H.key,
                scope: "col",
                class: te(H),
                title: H.headerTitle,
                ...
                createBaseVNode("div", jr, [
                  renderSlot(S.$slots, "sort-icon", {
                    ...
                    unref(z) && H.sortable ? (openBlock(), createElementBlock("span", {
                      key: 0,
                      class: normalizeClass(["b-table-sort-icon", {
                        sorted: H.key === e.sortBy,
                        [`sorted-${unref(d) ? "desc" : "asc"}`]: H.key === e.sortBy
                      }])
                    }, null, 2)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", null, [
                    S.$slots["head(" + H.key + ")"] || S.$slots["head()"] ? renderSlot(S.$slots, S.$slots["head(" + H.key + ")"] ? "head(" + H.key + ")" : "head()", {
                      key: 0,
                      label: H.label
                    }) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                      createTextVNode(toDisplayString(oe(H)), 1)
                    ], 64))
                  ])
                ])
              ], 16, Mr))), 128))
            ]),
            S.$slots["thead-sub"] ? (openBlock(), createElementBlock("tr", Gr, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(_), (H) => (openBlock(), createElementBlock("td", {
                key: H.key,
                scope: "col",
                class: normalizeClass([H.class, H.thClass, H.variant ? `table-${H.variant}` : ""])
              }, [
                S.$slots["thead-sub"] ? renderSlot(S.$slots, "thead-sub", mergeProps({
                  key: 0,
                  items: unref(_)
                }, H)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          ...
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(Y), (H, Ce) => (openBlock(), createElementBlock(Fragment, { key: Ce }, [
              createBaseVNode("tr", {
                class: normalizeClass(fe(H)),
                onClick: (re) => !unref(ut)(re) && be(H, Ce, re),
                onDblclick: (re) => !unref(ut)(re) && ee(H, Ce, re),
                onMouseenter: (re) => !unref(ut)(re) && me(H, Ce, re),
                onMouseleave: (re) => !unref(ut)(re) && ge(H, Ce, re)
              }, [
                unref(P) ? (openBlock(), createElementBlock("td", {
                  ...
                  renderSlot(S.$slots, "select-cell", {}, () => [
                    createBaseVNode("span", {
                      class: normalizeClass(C.value.has(H) ? "text-primary" : "")
                    }, "\u{1F5F9}", 2)
                  ])
                ], 2)) : createCommentVNode("", true),
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(_), (re) => (openBlock(), createElementBlock("td", mergeProps({
                  key: re.key
                }, re.tdAttr, {
                  class: le(re, H)
                }), [
                  e.stacked && unref(m) ? (openBlock(), createElementBlock("label", Wr, toDisplayString(oe(re)), 1)) : createCommentVNode("", true),
                  S.$slots["cell(" + re.key + ")"] || S.$slots["cell()"] ? renderSlot(S.$slots, S.$slots["cell(" + re.key + ")"] ? "cell(" + re.key + ")" : "cell()", {
                    key: 1,
                    value: H[re.key],
                    index: Ce,
                    item: H,
                    ...
                    createTextVNode(toDisplayString(H[re.key]), 1)
                  ], 64))
                ], 16))), 128))
              ], 42, Ur),
              H._showDetails === true && S.$slots["row-details"] ? (openBlock(), createElementBlock("tr", {
                key: 0,
                class: normalizeClass(fe(H))
              }, [
                createBaseVNode("td", { colspan: unref(N) }, [
            ...
            y.value ? (openBlock(), createElementBlock("tr", {
              ...
              createBaseVNode("td", { colspan: unref(N) }, [
                renderSlot(S.$slots, "table-busy", {}, () => [
                  createBaseVNode("div", Jr, [
                    createVNode(St, { class: "align-middle" }),
                    Yr
                  ])
                ])
              ], 8, Xr)
            ], 2)) : createCommentVNode("", true),
            unref(V) && unref(Y).length === 0 ? (openBlock(), createElementBlock("tr", Zr, [
              createBaseVNode("td", { colspan: unref(N) }, [
          ...
          unref(f) ? (openBlock(), createElementBlock("tfoot", eu, [
            createBaseVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(_), (H) => (openBlock(), createElementBlock("th", mergeProps({
                key: H.key
              }, H.thAttr, {
                ...
                abbr: H.headerAbbr,
                style: H.thStyle,
                onClick: (Ce) => K(H, Ce, true)
              }), toDisplayString(H.label), 17, tu))), 128))
            ])
          ])) : S.$slots["custom-foot"] ? (openBlock(), createElementBlock("tfoot", au, [
            renderSlot(S.$slots, "custom-foot", {
              fields: unref(_),
              items: e.items,
              columns: (ie = unref(_)) == null ? void 0 : ie.length
            })
          ])) : createCommentVNode("", true),
          S.$slots["table-caption"] ? (openBlock(), createElementBlock("caption", lu, [
            renderSlot(S.$slots, "table-caption")
          ])) : e.caption ? (openBlock(), createElementBlock("caption", nu, toDisplayString(e.caption), 1)) : createCommentVNode("", true)
        ];
      }),
      _: 3
    }, 16));
...
var iu = ["scope", "colspan", "rowspan", "data-label"];
var ru = { key: 0 };
var uu = defineComponent({
  ...
  setup(e) {
    ...
    return (u, f) => (openBlock(), createElementBlock("td", {
      ...
      e.stackedHeading ? (openBlock(), createElementBlock("div", ru, [
        renderSlot(u.$slots, "default")
...
var cu = ["scope", "colspan", "rowspan", "data-label"];
var fu = { key: 0 };
var vu = defineComponent({
  ...
  setup(e) {
    ...
    return (u, f) => (openBlock(), createElementBlock("th", {
      ...
      e.stackedHeading !== void 0 ? (openBlock(), createElementBlock("div", fu, [
        renderSlot(u.$slots, "default")
      ])) : renderSlot(u.$slots, "default", { key: 1 })
    ], 10, cu));
  }
...
var gu = ["id", "data-bs-target", "aria-controls", "aria-selected", "onClick"];
var Nl = Symbol();
var pu = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "card")), n = r(toRef(a, "end")), u = r(toRef(a, "fill")), f = r(toRef(a, "justified")), d = r(toRef(a, "lazy")), v = r(toRef(a, "noFade")), p = r(toRef(a, "noNavStyle")), $ = r(toRef(a, "pills")), m = r(toRef(a, "small")), B = r(toRef(a, "vertical")), V = useSlots(), T = ref(a.modelValue), b = ref(""), k = computed({
      get: () => T.value,
      set: (w) => {
      ...
      let w = [];
      return V.default && (w = I(V).map((P, z) => {
        P.props || (P.props = {});
        const Q = P.props["button-id"] || Ee("tab"), Y = P.props.id || Ee(), oe = k.value > -1 ? z === k.value : P.props.active === "", K = P.props["title-item-class"], be = P.props["title-link-attributes"];
        return {
          buttonId: Q,
          contentId: Y,
          active: oe,
    ...
    }), C = computed(() => !((y == null ? void 0 : y.value) && y.value.length > 0)), R = computed(() => ({
      "d-flex": B.value,
      "align-items-start": B.value
    })), D = st(toRef(a, "align")), F = computed(() => ({
      "nav-pills": $.value,
      ...
      if (w !== void 0 && w > -1 && w < y.value.length && !y.value[w].disabled && (k.value < 0 || y.value[w].buttonId !== b.value)) {
        const z = new yt("activate-tab", { cancelable: true, vueTarget: this });
        t("activate-tab", w, k.value, z), z.defaultPrevented || (k.value = w, P = true);
      }
      return !P && a.modelValue !== k.value && t("update:modelValue", k.value), P;
    }, N = (w, P) => {
      var z;
      _(P), P >= 0 && !y.value[P].disabled && ((z = y.value[P]) == null ? void 0 : z.onClick) && typeof y.value[P].onClick == "function" && y.value[P].onClick(w);
    }, I = (w) => !w || !w.default ? [] : w.default().reduce((P, z) => (typeof z.type == "symbol" ? P = P.concat(z.children) : P.push(z), P), []).filter((P) => {
      var z;
      return ((z = P.type) == null ? void 0 : z.__name) === "BTab";
    });
    return _(T.value), watch(
      ...
      () => {
        ...
        w < 0 && (k.value >= y.value.length ? w = y.value.map((P) => !P.disabled).lastIndexOf(true) : y.value[k.value] && !y.value[k.value].disabled && (w = k.value)), w < 0 && (w = y.value.map((P) => !P.disabled).indexOf(true)), y.value.forEach((P, z) => P.active = z === w), _(w);
      }
    ), onMounted(() => {
      ...
      id: e.id,
      class: normalizeClass(["tabs", unref(R)])
    }, {
      default: withCtx(() => [
        unref(n) ? (openBlock(), createElementBlock("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(y), ({ tabComponent: z, contentId: Q, tabClasses: Y, active: oe }, K) => (openBlock(), createBlock(resolveDynamicComponent(z()), {
            id: Q,
            key: K,
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("ul", {
            class: normalizeClass(["nav", [unref(F), e.navClass]]),
            role: "tablist"
          }, [
            renderSlot(w.$slots, "tabs-start"),
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(y), ({ tab: z, buttonId: Q, contentId: Y, navItemClasses: oe, active: K, target: be }, ee) => (openBlock(), createElementBlock("li", {
              key: ee,
              class: normalizeClass(["nav-item", z.props["title-item-class"]])
            }, [
              createBaseVNode("button", mergeProps({
                ...
                onClick: withModifiers((me) => N(me, ee), ["stop", "prevent"])
              }), [
                z.children && z.children.title ? (openBlock(), createBlock(resolveDynamicComponent(z.children.title), { key: 0 })) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                  createTextVNode(toDisplayString(z.props.title), 1)
                ], 64))
              ], 16, gu)
            ], 2))), 128)),
...
var hu = defineComponent({
  ...
  setup(e) {
    const t = e, a = inject(Nl, null), l = r(toRef(t, "active")), n = r(toRef(t, "disabled")), u = r(toRef(t, t.lazyOnce !== void 0 ? "lazyOnce" : "lazy")), f = ref(false), d = computed(() => !!((a == null ? void 0 : a.lazy) || u.value)), v = computed(() => t.lazyOnce !== void 0), p = computed(() => l.value && !n.value), $ = computed(() => {
    ...
    return watch(
      () => $.value,
      (B) => {
        B && !f.value && (f.value = true);
      }
    ), (B, V) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      id: e.id,
      ...
      default: withCtx(() => [
        unref($) ? renderSlot(B.$slots, "default", { key: 0 }) : createCommentVNode("", true)
      ]),
      _: 3
    }, 8, ["id", "class"]));
  }
